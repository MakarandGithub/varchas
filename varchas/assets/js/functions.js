...
var  sportsImage = jQuery('#sports').data('background-image');
var  aboutImage = jQuery('#about').data('background-image');
var  sochImage = jQuery('#soch').data('background-image');
var  marathonImage = jQuery('#marathon').data('background-image');
...
if (sportsImage) {  jQuery('#sports').css({ 'background-image':'url(' + sportsImage + ')' }); };
if (aboutImage) {  jQuery('#about').css({ 'background-image':'url(' + aboutImage + ')' }); };
if (sochImage) {  jQuery('#soch').css({ 'background-image':'url(' + sochImage + ')' }); };
if (marathonImage) {  jQuery('#marathon').css({ 'background-image':'url(' + marathonImage + ')' }); };
...
*/
	...
	$('.next-section .go-to-about').click(function() {
        ...
        $('.next-section .go-to-sports').click(function() {
    	$('html,body').animate({scrollTop:$('#sports').offset().top}, 1000);
  	});
        $('.next-section .go-to-soch').click(function() {
    	$('html,body').animate({scrollTop:$('#soch').offset().top}, 1000);
  	});
        $('.next-section .go-to-marathon').click(function() {
    	$('html,body').animate({scrollTop:$('#marathon').offset().top}, 1000);
  	});
    ...
    $(".news-letter").ajaxChimp({
        ...
        url: "http://jeweltheme.us10.list-manage.com/sponsors/post?u=a3e1b6603a9caac983abe3892&amp;id=257cf1a459" // Replace your mailchimp post url inside double quote "".  
    });
